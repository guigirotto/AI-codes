...
def run_neural_network2():
    ...
    print("A taxa é: ")
    print(taxa)
    np.savetxt("vanterior_taxa_"+str(taxa).replace('.','')+'.txt',vanterior,delimiter=';')
    np.savetxt("wanterior_"+str(taxa).replace('.','')+'.txt',wanterior,delimiter=';')
    np.savetxt("v0nanterior_taxa_"+str(taxa).replace('.','')+'.txt',v0anterior,delimiter=';')
    np.savetxt("w0nanterior_taxa_"+str(taxa).replace('.','')+'.txt',w0anterior,delimiter=';')
