...
def show_chart(best_chromosome_list, genetic_algoritm,):
    ...
    bin_x, bin_y = best_chromosome_list[index].genetic_code[:int(len(best_chromosome_list[index].genetic_code) / 2)], best_chromosome_list[index].genetic_code[int(len(best_chromosome_list[index].genetic_code) / 2):]
