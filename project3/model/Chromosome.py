...
class Chromosome:
    ...
    def calculate_fitness(self):
        ...
        new_fitness = 0
        for i in range(0,len(self.genetic_code)-1,2):
        ...
        new_fitness = new_fitness + matrix.item((value_matrix(self.genetic_code[17]),value_matrix(self.genetic_code[18])))
        new_fitness = new_fitness + matrix.item((value_matrix(),value_matrix(self.genetic_code[0])))
        new_fitness = new_fitness + matrix.item((value_matrix(self.genetic_code[18]),value_matrix()))
